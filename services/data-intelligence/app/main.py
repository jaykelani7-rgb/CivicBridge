...
from app.domain.ports import FallbackAnalyticalRepository, FallbackGeographyProvider
...
def create_app(settings: Optional[Settings] = None, *, publisher=None) -> FastAPI:
    ...
    migration = BASE_DIR / "migrations" / "001_initial.sql"
    repository = SQLiteRepository(settings.database_path,migration)
